    ...
    <section class="row justify-content-center">
      <section class="col-12 col-sm-6 col-md-4">
                <form class="form-container" action="loginform"  method="post">
                  <center><h3 class="a">${voted}</h3></center>
                  <center><h3 class="a">${message}</h3></center>
                  <center><h3 class="a">${success}</h3></center>
                  ...
                  <div class="form-group">
                  <a href="reg" class="btn btn-primary btn-lg float-left">REGISTER</a>
                   </div>   
                  </div>
